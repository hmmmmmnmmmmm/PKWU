			...
			<div class="mb-3">
				...
				<div class="input-group">
					...
					<select name="layanan" class="form-select" required>
						<option value="1">165rb 25mbps</option>
						<option value="2">110k 10mbps</option>
						<option value="3">590k 100mbps</option>
						<option value="4">515k 50mbps</option>
						<option value="5">485k 100mbps</option>
					</select>
				</div>
			</div>
