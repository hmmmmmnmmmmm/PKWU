  ...
  <?php foreach ($laporan as $l): ?>
			<div class="d-flex justify-content-between align-items-center p-2 mb-2 bg-light rounded">
				<div>
					...
					<strong><?= $l->no_rek; ?></strong><br>
					<small class="text-muted"><?= $l->bukti; ?></small>
				</div>
				<a href="<?= site_url('pelanggan/detail/' . $l->id_pembayaran); ?>" class="btn btn-outline-primary btn-sm">Detail</a>
			</div>
		<?php endforeach; ?>
	</div>
	<!-- Bottom Navbar -->
